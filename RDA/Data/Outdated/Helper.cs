...
namespace RDA {
  ...
  public static class Helper {
    ...
    internal static void TemplateBuildPermitBuilding(XElement item) {
      ...
      textEN = Assets.Original.XPathSelectElement($"//Asset[Template='Text']/Values/Standard[GUID={ornamentGuid}]/../Text/LocaText/English/Text").Value;
    ...
    internal static void TemplateGuildhouseItem(XElement item) {
      ...
      textEN = Assets.Original.XPathSelectElement($"//Asset[Template='Text']/Values/Standard[GUID={infoGuid}]/../Text/LocaText/English/Text").Value;
