  ...
  public class FactoryBase {
    ...
    public XElement ToXml() {
      ...
      if (this.CycleTime != null) {
        result.Add(new XAttribute("CycleTime", this.CycleTime));
      }
      if (FactoryInputs != null) {
        result.Add(new XElement("FactoryInputs", this.FactoryInputs.Select(s => s.ToXml())));
      }
      if (FactoryOutputs != null) {
        result.Add(new XElement("FactoryOutputs", this.FactoryOutputs.Select(s => s.ToXml())));
      }
      return result;
    }
