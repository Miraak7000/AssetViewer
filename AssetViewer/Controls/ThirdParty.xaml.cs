...
namespace AssetViewer.Controls {
    ...
    public partial class ThirdParty : UserControl, INotifyPropertyChanged {
        ...
        public IEnumerable<TemplateAsset> Items {
            get {
                if (!(this.ComboBoxThirdParty.SelectedItem is Tuple<String, String> thirdParty) || !(this.ComboBoxProgressions.SelectedItem is Tuple<Progression, String> progression))
                ...
                switch (App.Language) {
                    case Languages.German:
                        return result.OrderBy(o => o.Text.DE);
                    default:
                        return result.OrderBy(o => o.Text.EN);
                }
            }
        }
