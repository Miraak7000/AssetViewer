...
namespace AssetViewer.Controls {
  ...
  public partial class Monument : UserControl, INotifyPropertyChanged {
    ...
    public IEnumerable<SelectableItem> Categories {
      get {
        return this.AssetCategory.XPathSelectElements("Asset/Values").Select(s => new SelectableItem {
    ...
    public IEnumerable<SelectableItem> Events {
      get {
        ...
        return this.AssetEvent.Elements().Where(w => assetEvents.Contains(w.XPathSelectElement("Values/Standard/GUID").Value)).Select(s => new SelectableItem {
    ...
    public IEnumerable<SelectableItem> Rewards {
      get {
        ...
        return this.AssetReward.Elements().Where(w => assetRewards.Contains(w.XPathSelectElement("Values/Standard/GUID").Value)).Select(s => new SelectableItem {
          GUID = s.XPathSelectElement("Values/Standard/GUID").Value,
          Value = s.XPathSelectElement("Values/Description"),
          IconFilename = s.XPathSelectElement("Values/Standard/IconFilename").Value
        });
